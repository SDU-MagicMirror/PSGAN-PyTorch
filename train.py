...
from solver_makeupgan import Solver_MakeupGAN
...
def parse_args():
    ...
    parser.add_argument('--data_path', default='/home/zhiyong/RemoteServer/data/makeup_dataset', type=str,
                        help='training and test data path')
    # parser.add_argument('--data_path', default='/home/mist/data/makeup_dataset', type=str,
    #                     help='training and test data path')
    ...
    parser.add_argument('--dataset', default='MAKEUP', type=str,
                        help='dataset name, MAKEUP means two domain, MMAKEUP means multi-domain')
    ...
    parser.add_argument('--norm', default='SN', type=str,
    ...
    parser.add_argument('--lambda_skin_1', default='0.1', type=float,
                        help='histogram loss on skin equals to lambda_his* lambda_skin')
    parser.add_argument('--lambda_skin_2', default='0.1', type=float,
                        help='histogram loss on skin equals to lambda_his* lambda_skin')
    parser.add_argument('--lambda_eye', default='1', type=float,
